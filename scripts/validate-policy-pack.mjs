...
// The pure resource-routing implementation now lives in the shared library so
// the Operational Router adapter and this conformance checker consume ONE
// implementation, never a duplicate copy. Imported for local use here...
import {
  isPlainObject,
  isNonEmptyString,
  tierIndex,
